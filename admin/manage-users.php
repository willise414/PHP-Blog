...
// fetch users from database, but not current user. Should not be able to delete yourself
...
<section class="dashboard">
  ...
  <?php elseif (isset($_SESSION['edit-user'])) : //shows if edit user NOT successful 
  ?>
  ...
  <?php elseif (isset($_SESSION['delete-user'])) : //shows if delete user NOT successful 
  ?>
    <div class="alert__message error container">
      <p>
